...
>
> VS Code Git 插件：Git Graph，GitLens，https://blog.csdn.net/qq_39611230/article/details/111570527
...
<img src="vue/image-20230628085825342.png" alt="image-20230628085825342" style="zoom:50%;" />
...
<img src="vue/image-20230628130054530.png" alt="image-20230628130054530" style="zoom: 67%;" />
...
<script type="text/javascript">
    ...
    new Vue({
        ...
        components: {
            // school与标签名对应, s与组件名对应, 如果二者是同一个单词, 可以简写为: school
            school: school
        }
    })
</script>
...
<img src="vue/image-20230628172446838.png" alt="image-20230628172446838" style="zoom: 67%;" />
...
<img src="vue/image-20230628175608620.png" alt="image-20230628175608620" style="zoom: 50%;" />

- **`实例的隐式原型属性，永远指向该实例缔造者的原型对象，Object 的原型对象的隐式原型属性指向 null。`**
- Vue 的原型对象的隐式原型属性，指向 Object 的原型对象。

- VueComponent 的原型对象的隐式原型属性，本应指向 Object 的原型对象，但 Vue 进行了修改，将其指向了 Vue 的原型对象。
